...
#define defgKeySysWorkspacePrev         'z', kfAlt+kfCtrl, "Alt+Ctrl+z"
#define defgKeySysWorkspaceNext         'x', kfAlt+kfCtrl, "Alt+Ctrl+x"
#define defgKeySysWorkspaceLast         XK_Down, kfAlt+kfCtrl, "Alt+Ctrl+Down"
#define defgKeySysWorkspacePrevTakeWin  'z', kfAlt+kfCtrl+kfShift, "Alt+Ctrl+Shift+z"
#define defgKeySysWorkspaceNextTakeWin  'x', kfAlt+kfCtrl+kfShift, "Alt+Ctrl+Shift+x"
